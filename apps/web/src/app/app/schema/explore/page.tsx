  ...
  return (
    <div>
      <PageHeader
        ...
        description="Interactive graph view of published GraphQL schemas (Voyager)."
      />

      {!projects.length ? (
        <p className="text-sm text-muted-foreground">
          No projects yet.{" "}
          <Link href="/app/projects" className="text-primary underline-offset-4 hover:underline">
            Create a project
          </Link>{" "}
          and publish a schema first.
        </p>
      ) : (
        <>
